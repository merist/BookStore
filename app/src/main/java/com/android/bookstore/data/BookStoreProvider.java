...
public class BookStoreProvider  extends ContentProvider {
    ...
    /**
     * URI matcher code for the content URI for a single entry in the book table
     */
    ...
    static {
        ...
        // For example, "content://com.android.bookstore/books/3" matches, but
        // "content://com.android.bookstore/books" (without a number at the end) doesn't match.
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        Integer quantity = values.getAsInteger(BookStoreEntry.COLUMN_QUANTITY);
    ...
    private int updateBook(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(BookStoreContract.BookStoreEntry.COLUMN_PRODUCT_NAME)) {
            String name = values.getAsString(BookStoreContract.BookStoreEntry.COLUMN_PRODUCT_NAME);
            if (name == null) {
